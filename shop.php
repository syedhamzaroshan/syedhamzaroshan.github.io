...
<body>
            ...
            <div class="container nav-container">
                ...
                <div class="collapse navbar-collapse" id="billatrail_main_menu">
                    <ul class="navbar-nav menu-open">
                        ...
                        <li class="hidden-md"><a href="about.php">About</a></li>
                        <!-- <li class="menu-item-has-children">
                            <a href="#">Classes</a>
                            <ul class="sub-menu">
    ...
    <!-- breadcrumb area -->
    <div class="breadcrumb-style-1" style="background-image:url(https://syedhamzaroshan.github.io/modules/ui/img/bg/shop.png);">
                        ...
                        <div class="row d-flex justify-content-lg-between flex-column flex-md-row align-items-center text-center">
                            ...
                            <div class="search-menu">
                                <ul>
                                    ...
                                    <li><a href="#">Dumbell</a></li>
                                    <li><a href="#">Triceaps Extension</a></li>
                                    <li><a href="#">Traidmail</a></li>
                                    <li><a href="#">Yoga Ball</a></li>
                                    <li><a href="#">Gym</a></li>
                                </ul>
                            </div>
                        </div>
            ...
            <div class="row shopping-slider-item text-center">
                ...
                <div class="col-md-3">
                    <div class="shop-single-item margin-bottom-50">
                        <div class="top-content">
                            <div class="thumb">
                                <img src="https://syedhamzaroshan.github.io/modules/ui/img/home/shopping/6.png" alt="shopping">
                            </div>
                            <div class="hover-content">
                                <div class="btn-wrapper desktop-center">
                                    <a href="#" class="btn btn-element btn-normal-size btn-rounded">Add to cart</a>
                ...
                <div class="col-md-3">
                    <div class="shop-single-item margin-bottom-50">
                        <div class="top-content">
                            <div class="thumb">
                                <img src="https://syedhamzaroshan.github.io/modules/ui/img/home/shopping/7.png" alt="shopping">
                            </div>
                            <div class="hover-content">
                                <div class="btn-wrapper desktop-center">
                                    <a href="#" class="btn btn-element btn-normal-size btn-rounded">Add to cart</a>
                ...
                <div class="col-md-3">
                    <div class="shop-single-item margin-bottom-50">
                        <div class="top-content">
                            <div class="thumb">
                                <img src="https://syedhamzaroshan.github.io/modules/ui/img/home/shopping/8.png" alt="shopping">
                            </div>
                            <div class="hover-content">
                                <div class="btn-wrapper desktop-center">
                                    <a href="#" class="btn btn-element btn-normal-size btn-rounded">Add to cart</a>
                ...
                <div class="col-md-3">
                    <div class="shop-single-item margin-bottom-50">
                        <div class="top-content">
                            <div class="thumb">
                                <img src="https://syedhamzaroshan.github.io/modules/ui/img/home/shopping/9.png" alt="shopping">
                            </div>
                            <div class="hover-content">
                                <div class="btn-wrapper desktop-center">
                                    <a href="#" class="btn btn-element btn-normal-size btn-rounded">Add to cart</a>
                ...
                <div class="col-md-3">
                    <div class="shop-single-item margin-bottom-50">
                        <div class="top-content">
                            <div class="thumb">
                                <img src="https://syedhamzaroshan.github.io/modules/ui/img/home/shopping/10.png" alt="shopping">
                            </div>
                            <div class="hover-content">
                                <div class="btn-wrapper desktop-center">
                                    <a href="#" class="btn btn-element btn-normal-size btn-rounded">Add to cart</a>
                ...
                <div class="col-md-3">
                    <div class="shop-single-item margin-bottom-50">
                        <div class="top-content">
                            <div class="thumb">
                                <img src="https://syedhamzaroshan.github.io/modules/ui/img/home/shopping/11.png" alt="shopping">
                            </div>
                            <div class="hover-content">
                                <div class="btn-wrapper desktop-center">
                                    <a href="#" class="btn btn-element btn-normal-size btn-rounded">Add to cart</a>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="copyright-area-inner">
                            © Zarxio 2019 All rights reserved. Powered with <i class="fa fa-heart"></i>  by <a href="http://zwin.io/" target="_blank">Zwin</a>
                        </div>
                    </div>
                </div>
            </div>

...
<body>
    ...
    <!-- breadcrumb area -->
    <div class="breadcrumb-style-1" style="background-image:url(http://localhost/sportsearth/modules/ui/img/bg/service.png);">
